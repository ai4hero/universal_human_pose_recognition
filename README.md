...
## License description
Apache 2.0 license, any form of reference or use needs to contact the author himself. Authors will authorize users as appropriate:
Authorization format: Authorized subject | Authorization time limit | Authorization range | Authorization method | Authorized host code | Authorized memory card code | Authorized MAC address
